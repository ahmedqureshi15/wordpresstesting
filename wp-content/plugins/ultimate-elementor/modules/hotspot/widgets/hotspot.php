				...
				$repeater->start_controls_tab( 'style_tab', [ 'label' => __( 'Style', 'uael' ) ] );
					...
					$repeater->add_control(
						...
						[
							...
							'default'   => '',
							'selectors' => [
								'{{WRAPPER}} {{CURRENT_ITEM}} .uael-hotspot-content, {{WRAPPER}} {{CURRENT_ITEM}} .uael-hotspot-content.uael-hotspot-anim:before' => 'color: {{VALUE}};',
							],
							'condition' => [
								'hotspot_marker_options' => 'yes',
								'hotspot'                => [ 'text', 'icon' ],
					...
					$repeater->add_control(
						...
						[
							...
							'selectors' => [
								'{{WRAPPER}} {{CURRENT_ITEM}} .uael-hotspot-content, {{WRAPPER}} {{CURRENT_ITEM}} .uael-hotspot-content.uael-hotspot-anim:before' => 'background-color: {{VALUE}};',
							],
						]
					);
		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors'  => [
						'{{WRAPPER}} .uael-hotspot-content, {{WRAPPER}} .uael-hotspot-content.uael-hotspot-anim:before' => 'min-width: {{SIZE}}{{UNIT}}; min-height: {{SIZE}}{{UNIT}}; line-height: {{SIZE}}{{UNIT}};',
					],
				]
			);
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						...
						[
							...
							'default'   => '',
							'selectors' => [
								'{{WRAPPER}} .uael-hotspot-content, {{WRAPPER}} .uael-hotspot-content.uael-hotspot-anim:before' => 'color: {{VALUE}};',
							],
						]
					);
					...
					$this->add_control(
						...
						[
							...
							'selectors' => [
								'{{WRAPPER}} .uael-hotspot-content, {{WRAPPER}} .uael-hotspot-content.uael-hotspot-anim:before' => 'background-color: {{VALUE}};',
							],
						]
					);
					...
					$this->add_control(
						...
						[
							...
							'selectors' => [
								'{{WRAPPER}} .uael-hotspot-content, {{WRAPPER}} .uael-hotspot-content.uael-hotspot-anim:before' => 'border-radius: {{SIZE}}px;',
							],
						]
					);
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						...
						[
							...
							'selectors' => [
								'{{WRAPPER}} .uael-hotspot-content:hover, {{WRAPPER}} .uael-hotspot-content.uael-hotspot-anim:hover:before, {{WRAPPER}} .uael-hotspot-tour .uael-hotspot-content.open, {{WRAPPER}} .uael-hotspot-tour .open.uael-hotspot-anim:before' => 'background-color: {{VALUE}};',
							],
						]
					);
			...
			<div class="uael-hotspot-container" <?php echo $this->get_data_attrs( $settings, $device ); ?>>
				...
				foreach ( $settings['hotspots_list'] as $index => $item ) :
					...
					<span class="uael-tooltip elementor-repeater-item-<?php echo $item['_id']; ?>">
						<span class="uael-hotspot-main-<?php echo $node_id; ?> uael-hotspot-content<?php echo $hotspot_glow; ?>" id="uael-tooltip-id-<?php echo $node_id . '-' . $counter; ?>" data-uaeltour="<?php echo $counter; ?>" data-tooltip-content="<?php echo '#uael-tooltip-content-' . $content_id; ?>">
							<?php
							if ( $hotspot_icon ) {
								?>
					...
					<div class="uael-hotspot-container" {{{ param }}}>
						<# _.each( settings.hotspots_list, function( item ) {
							...
							<span class="uael-tooltip elementor-repeater-item-{{ item._id }}">
								<span class="uael-hotspot-main-{{ node_id }} uael-hotspot-content{{ hotspot_glow }}" id="uael-tooltip-id-{{ node_id }}-{{ counter }}" data-uaeltour="{{ counter }}" data-tooltip-content="#uael-tooltip-content-{{ item._id }}">
